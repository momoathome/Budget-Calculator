...
const { data: users, pending, promise: usersPromise } = useDatabaseObject<ObjFirebaseUsers>(usersRef)
await usersPromise.value

const user: UserObject = reactive({
  data: computed<FirebaseUser>(() => users.value!.user1),
