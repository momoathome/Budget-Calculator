...
<template>
  <div class="h-100dvh overflow-hidden bg-white dark:bg-base" :class="{ 'h-[calc(100dvh+230px)]!': showRegister, 'h-[calc(100dvh+200px)]!': showLogin }">
    <the-navbar />
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl lg:py-56 sm:py-32">
